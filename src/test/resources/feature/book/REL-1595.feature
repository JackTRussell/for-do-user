@ST_60406 @this_is_story_tag @tagtagtag
...
@SC_227533 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_227534 @third_scenario_tag
...
@SC_227535 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_227536 @fifth_scenario_tag
