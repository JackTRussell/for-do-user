@ST_77401 @this_is_story_tag @tagtagtag
...
@SC_290642 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_290643 @third_scenario_tag
...
@SC_290644 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_290645 @fifth_scenario_tag
